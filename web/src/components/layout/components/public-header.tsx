...
export function PublicHeader(props: PublicHeaderProps) {
  ...
  if (isEditorial) {
    headerContainerClassName = 'max-w-7xl px-5 md:px-8'
    headerNavClassName = scrolled
      ? 'border-border/60 bg-background/92 h-16 border-b backdrop-blur-xl'
      : 'h-[4.75rem] border-b border-transparent'
  } else if (scrolled) {
  ...
  let desktopAuthAction: React.ReactNode = (
    <Button
      ...
      className={cn(
        ...
        isEditorial ? 'rounded-full' : 'rounded-lg'
      )}
