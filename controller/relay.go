...
func executeTaskSubmissionWith(
	...
	task.PrivateData.QuotaDataCreatedAt = relayInfo.StartTime.Unix()
	if task.PrivateData.QuotaDataCreatedAt <= 0 {
		task.PrivateData.QuotaDataCreatedAt = common.GetTimestamp()
	}
	task.PrivateData.QuotaDataTracked = common.LogConsumeEnabled && common.DataExportEnabled
