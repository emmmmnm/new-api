...
func RelaySwapFace(c *gin.Context, info *relaycommon.RelayInfo) *dto.MidjourneyResponse {
	...
	quotaDataTracked := mjResp.StatusCode == http.StatusOK && midjResponse.Code == 1 && common.LogConsumeEnabled && common.DataExportEnabled
	...
	if billingApplied {
		midjourneyTask.QuotaDataTracked = common.LogConsumeEnabled && common.DataExportEnabled
